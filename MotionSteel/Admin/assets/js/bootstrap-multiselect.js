        ...
        buildSelectAll: function() {
            ...
            if (!alreadyHasSelectAll && this.options.includeSelectAllOption && this.options.multiple
                ...
                if (this.options.selectAllName) {
                    $('label', $li).append('<input class="ace" type="checkbox" name="' + this.options.selectAllName + '" />');
                    $('label', $li).append('<span class="lbl"></span>');
                }
                else {
                    $('label', $li).append('<input class="ace" type="checkbox" />');
                    $('label', $li).append('<span class="lbl"></span>');
                }
